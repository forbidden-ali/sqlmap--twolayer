...
def sqlmap_craw(origin_http_url_or_file):
	...
	sqlmap_string='''"F:\\Program Files (x86)\\sqlmap\\sqlmapproject-sqlmap-59ff811\\sqlmap.py" -u "%s" --referer="%s" --crawl=3 --delay 2 --smart -v 4 --threads 6 --batch --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,charencode --risk=3''' % (origin_http_url,origin_http_url,origin_http_url)
	forms_sqlmap_string='''"F:\\Program Files (x86)\\sqlmap\\sqlmapproject-sqlmap-59ff811\\sqlmap.py" -u "%s" --referer="%s" --crawl=3 --delay 2 --smart -v 4 --threads 6 --batch --random-agent --safe-url "%s" --safe-freq 1 --tamper=between,space2randomblank,randomcase,charencode --risk=3 --forms''' % (origin_http_url,origin_http_url,origin_http_url)
